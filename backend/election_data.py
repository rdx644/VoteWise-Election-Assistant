...
QUIZ_QUESTIONS: list[QuizQuestion] = [
    # Easy questions
    QuizQuestion(
        id="q-001", question="What is the minimum voting age in the United States?",
        options=["16", "17", "18", "21"], correct_answer=2,
        explanation="The 26th Amendment set the voting age at 18.", difficulty=QuizDifficulty.EASY,
        topic="voter_eligibility", phase=ElectionPhase.VOTER_REGISTRATION,
    ),
    QuizQuestion(
        id="q-002", question="When is Election Day for federal elections in the U.S.?",
        options=["First Monday in November", "First Tuesday after the first Monday in November",
                 "November 1st", "Last Tuesday in October"], correct_answer=1,
        explanation="Federal elections are held on the first Tuesday after the first Monday in November.",
        difficulty=QuizDifficulty.EASY, topic="election_day", phase=ElectionPhase.ELECTION_DAY,
    ),
    QuizQuestion(
        id="q-003", question="What website can you use to register to vote online?",
        options=["voting.com", "vote.gov", "register.us", "election.gov"], correct_answer=1,
        explanation="vote.gov provides voter registration information for all states.",
        difficulty=QuizDifficulty.EASY, topic="voter_registration", phase=ElectionPhase.VOTER_REGISTRATION,
    ),
    QuizQuestion(
        id="q-004", question="Which of these is NOT a requirement to vote in the U.S.?",
        options=["Be a U.S. citizen", "Be at least 18", "Own property", "Meet residency requirements"],
        correct_answer=2, explanation="Property ownership has not been a voting requirement since the early 1800s.",
        difficulty=QuizDifficulty.EASY, topic="voter_eligibility",
    ),
    QuizQuestion(
        id="q-005", question="What is an absentee ballot?",
        options=["A ballot cast in person", "A ballot mailed or submitted before Election Day",
                 "A practice ballot", "A ballot for overseas military only"], correct_answer=1,
        explanation="Absentee ballots allow voters to vote by mail before Election Day.",
        difficulty=QuizDifficulty.EASY, topic="absentee_voting", phase=ElectionPhase.EARLY_VOTING,
    ),
    QuizQuestion(
        id="q-006", question="How often are U.S. presidential elections held?",
        options=["Every 2 years", "Every 4 years", "Every 5 years", "Every 6 years"],
        correct_answer=1, explanation="Presidential elections occur every 4 years.",
        difficulty=QuizDifficulty.EASY, topic="election_schedule",
    ),
    QuizQuestion(
        id="q-007", question="What does it mean to 'register to vote'?",
        options=["Sign up for a political party", "Add your name to the list of eligible voters",
                 "Vote in an election", "Volunteer at a polling place"], correct_answer=1,
        explanation="Registering adds you to the official list of eligible voters in your jurisdiction.",
        difficulty=QuizDifficulty.EASY, topic="voter_registration", phase=ElectionPhase.VOTER_REGISTRATION,
    ),
    # Medium questions
    QuizQuestion(
        id="q-008", question="What is the difference between an open primary and a closed primary?",
        options=["Open primaries allow any voter; closed require party registration",
                 "Open primaries are held outdoors", "Closed primaries have no campaigning",
                 "There is no difference"], correct_answer=0,
        explanation="In open primaries, any registered voter can participate regardless of party affiliation.",
        difficulty=QuizDifficulty.MEDIUM, topic="primary_elections", phase=ElectionPhase.PRIMARY_ELECTION,
    ),
    QuizQuestion(
        id="q-009", question="How many Electoral College votes are needed to win the presidency?",
        options=["218", "250", "270", "300"], correct_answer=2,
        explanation="A candidate needs 270 out of 538 Electoral College votes to win.",
        difficulty=QuizDifficulty.MEDIUM, topic="electoral_college",
    ),
    QuizQuestion(
        id="q-010", question="What is a 'sample ballot' and why is it useful?",
        options=["A fake ballot for practice", "A preview of your actual ballot for preparation",
                 "A ballot used in polling place training", "A ballot for minors"], correct_answer=1,
        explanation="Sample ballots help voters review candidates and measures before Election Day.",
        difficulty=QuizDifficulty.MEDIUM, topic="voter_preparation", phase=ElectionPhase.ELECTION_DAY,
    ),
    QuizQuestion(
        id="q-011", question="What is a provisional ballot?",
        options=["A temporary ballot for undecided voters",
                 "A ballot given when voter eligibility needs verification",
                 "A ballot for write-in candidates only",
                 "A ballot used only in primaries"], correct_answer=1,
        explanation="Provisional ballots ensure no eligible voter is turned away; eligibility is verified later.",
        difficulty=QuizDifficulty.MEDIUM, topic="voting_methods", phase=ElectionPhase.ELECTION_DAY,
    ),
    QuizQuestion(
        id="q-012", question="What constitutional amendment gave women the right to vote?",
        options=["15th Amendment", "19th Amendment", "21st Amendment", "26th Amendment"],
        correct_answer=1, explanation="The 19th Amendment (1920) prohibited denying the right to vote based on sex.",
        difficulty=QuizDifficulty.MEDIUM, topic="voting_rights",
    ),
    QuizQuestion(
        id="q-013", question="What is gerrymandering?",
        options=["A type of voting machine", "Manipulating district boundaries for political advantage",
                 "A campaign strategy", "A voter suppression technique"], correct_answer=1,
        explanation="Gerrymandering is redrawing electoral district boundaries to favor a party.",
        difficulty=QuizDifficulty.MEDIUM, topic="electoral_systems",
    ),
    # Hard questions
    QuizQuestion(
        id="q-014", question="Which amendment abolished poll taxes in federal elections?",
        options=["15th Amendment", "19th Amendment", "24th Amendment", "26th Amendment"],
        correct_answer=2, explanation="The 24th Amendment (1964) eliminated poll taxes for federal elections.",
    ...
    QuizQuestion(
        id="q-017", question="What is the Voting Rights Act of 1965?",
        options=["Established the Electoral College", "Created the Federal Election Commission",
                 "Prohibited racial discrimination in voting", "Set the voting age to 18"],
        correct_answer=2, explanation="The VRA outlawed discriminatory voting practices, especially in the South.",
        difficulty=QuizDifficulty.HARD, topic="voting_rights",
    ),
    QuizQuestion(
        id="q-018", question="What is 'ballot curing' and which states allow it?",
        options=["Fixing errors on submitted ballots; varies by state",
                 "Printing new ballots", "Counting damaged ballots",
                 "Testing ballot machines"], correct_answer=0,
        explanation="Ballot curing allows voters to fix signature or other issues on their submitted ballots.",
        difficulty=QuizDifficulty.HARD, topic="voting_methods",
    ),
]
